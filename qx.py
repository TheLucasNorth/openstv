...
class QX(object):
  ...
  def set_guard(e, v):
    ...
    QX.guard = v
    QX.g = 10 ** QX.guard
    QX.grnd = old_div(QX.g,2)
    QX.geps = old_div(QX.g,10)
  ...
  def mult(a, b):
    ...
    return old_div(a * b, QX.p)

  @staticmethod
  def div(a, b):
    "divide two fixed-point numbers"
    return old_div((a * QX.p), b)
  ...
  def str(v):
    ...
    gv = old_div((v + QX.grnd),QX.g)	              # round off guard digits
    return nfmt % (old_div(gv,(old_div(QX.p,QX.g))), gv%(old_div(QX.p,QX.g)))
...
class RecursiveQXSTV(RecursiveSTV):
  ...
  def updateThresh(self):
    ...
    self.thresh[self.R] = old_div(threshNum,(self.numSeats + 1))
